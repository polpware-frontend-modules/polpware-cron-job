...
export class ScheduleTimeModalComponent extends ObservableModalAbstractComponent {
    ...
    static { this.ɵfac = function ScheduleTimeModalComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || ScheduleTimeModalComponent)(i0.ɵɵdirectiveInject(i1.BsModalRef), i0.ɵɵdirectiveInject(i1.BsModalService)); }; }
